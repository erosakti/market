--[[ 
    🛡️ AUTO BUY V119 - STABILITY EDITION
    
    Base: V117 (Turbo Speed, No Blacklist, No Filter).
    Fitur Tambahan:
    - ANTI-DISCONNECT: Otomatis rejoin jika internet putus/kena kick.
    - HIDE UI: Tekan [Right Ctrl] untuk menyembunyikan GUI (biar bersih).
]]
...
-- Ini akan mendeteksi jika muncul pesan Error (Disconnect) dan langsung rejoin
task.spawn(function()
